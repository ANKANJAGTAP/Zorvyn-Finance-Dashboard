...
const cards = [
  {
    ...
    label: 'Total Balance',
    icon: Wallet,
    tintClass: 'bg-primary/[0.06] border-primary/[0.15]',
    glowClass: 'shadow-[0_0_30px_rgba(66,124,240,0.2)]',
    gradientClass: 'bg-gradient-to-br from-primary/[0.08] to-primary/[0.02]',
  ...
  },
  {
    ...
    label: 'Income',
    icon: TrendingUp,
    tintClass: 'bg-success/[0.06] border-success/[0.15]',
    glowClass: 'shadow-[0_0_30px_rgba(34,195,142,0.2)]',
    gradientClass: 'bg-gradient-to-br from-success/[0.08] to-success/[0.02]',
  ...
  },
  {
    ...
    label: 'Expenses',
    icon: TrendingDown,
    tintClass: 'bg-danger/[0.06] border-danger/[0.15]',
    glowClass: 'shadow-[0_0_30px_rgba(239,68,68,0.18)]',
    gradientClass: 'bg-gradient-to-br from-danger/[0.08] to-danger/[0.02]',
  ...
  },
  {
    ...
    label: 'Savings Rate',
    icon: Percent,
    tintClass: 'bg-accent-purple/[0.06] border-accent-purple/[0.15]',
    glowClass: 'shadow-[0_0_30px_rgba(133,92,214,0.2)]',
    gradientClass: 'bg-gradient-to-br from-accent-purple/[0.08] to-accent-purple/[0.02]',
      ...
      {cards.map((card, index) => {
        ...
        return (
          <motion.button
            ...
            aria-label={`${card.label}: ${isPercentage ? formatSavingsDisplay(value) : formatAmount(value)}`}
            className={`relative overflow-hidden rounded-xl p-6 text-left cursor-pointer group border ${card.gradientClass} ${
              isSelected
                ? 'border-white/20'
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-3">
                ...
                <div
                  className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-300 group-hover:scale-110 border ${card.tintClass}`}
                >
                  {isNegativeSavings
